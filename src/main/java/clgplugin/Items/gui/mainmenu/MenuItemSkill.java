...
@ItemName(itemname = "menuitemskill")
public class MenuItemSkill extends ModItem {
    private ItemStack itemStack;
    private List<EnchantmentSub> enchantments = new ArrayList<>();
    private List<ItemFlag> flags = new ArrayList<>();

    public MenuItemSkill(){
        ...
        ItemCreator item = new ItemCreator(
                ...
                ChatColor.GRAY+"View your skill progression",
                " ",
                ChatColor.YELLOW+"37.5 Skill Avg.",
                " ",
